...
fn camellia_setup128(key: &[u8], subkey: &mut [u32; KEY_TABLE_LEN]) {
    ...
    krl = subl[1];
    krr = subr[1];
    camellia_f!(kll, klr, CAMELLIA_SIGMA1L, CAMELLIA_SIGMA1R, w0, w1, il, ir, t0, t1);
    krl ^= w0;
    krr ^= w1;
    camellia_f!(krl, krr, CAMELLIA_SIGMA2L, CAMELLIA_SIGMA2R, kll, klr, il, ir, t0, t1);
    camellia_f!(kll, klr, CAMELLIA_SIGMA3L, CAMELLIA_SIGMA3R, krl, krr, il, ir, t0, t1);
    krl ^= w0;
    krr ^= w1;
    camellia_f!(krl, krr, CAMELLIA_SIGMA4L, CAMELLIA_SIGMA4R, w0, w1, il, ir, t0, t1);
    kll ^= w0;
    klr ^= w1;
...
fn camellia_setup256(key: &[u8], subkey: &mut [u32; KEY_TABLE_LEN]) {
    ...
    krrl ^= krl;
    krrr ^= krr;
    camellia_f!(krll, krlr, CAMELLIA_SIGMA5L, CAMELLIA_SIGMA5R, w0, w1, il, ir, t0, t1);
    krrl ^= w0;
    krrr ^= w1;
    camellia_f!(krrl, krrr, CAMELLIA_SIGMA6L, CAMELLIA_SIGMA6R, w0, w1, il, ir, t0, t1);
    krll ^= w0;
    krlr ^= w1;
