...
impl Chacha20 {
    ...
    pub fn new(key: &[u8], nonce: &[u8]) -> Self {
        ...
        Self { cipher, nonce: nonce_copy, len: 0u64 }
    }
    ...
    fn in_place(&mut self, m: &mut [u8]) {
        ...
        let block_counter = if cfg!(any(target_pointer_width = "32", target_pointer_width = "64")) {
        ...
        self.cipher.encrypt_slice(block_counter, &self.nonce, &mut buf);
